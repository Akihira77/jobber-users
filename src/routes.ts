...
export function appRoutes(
    ...
    buyerAPI.use(verifyGatewayRequest);
    sellerAPI.use(verifyGatewayRequest);
...
function buyerRoute(
    ...
    api.get("/email", async (c: Context) => {
        ...
        return c.json({ message: "Buyer profile", buyer }, StatusCodes.OK);
    });
...
function sellerRoute(
    ...
    api.get("/id/:sellerId", async (c: Context) => {
        ...
        return c.json({ message: "Seller profile", seller }, StatusCodes.OK);
    });
